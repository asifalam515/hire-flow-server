...
export const sanitizeHTML = (html) => {
    ...
    sanitized = sanitized.replace(/\s(href|src)\s*=\s*["']?data:/gi, ' $1="javascript:void(0)"');
    // Remove javascript: protocol
    sanitized = sanitized.replace(/\s(href|src)\s*=\s*["']?javascript:/gi, ' $1="javascript:void(0)"');
    return sanitized;
};
/**
 ...
 */
export const validateHTMLLength = (html, maxLength = 5000) => {

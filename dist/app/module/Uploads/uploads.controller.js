...
export const getResumeSignedUrl = asyncHandler(async (req, res) => {
    ...
    const data = uploadsService.generateSignedUrl(folder, allowedFormats, maxBytes);
    res.status(200).json({
        success: true,
        data,
    });
});
export const getAvatarSignedUrl = asyncHandler(async (req, res) => {
...
export const confirmResume = asyncHandler(async (req, res) => {

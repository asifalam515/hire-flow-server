 ...
 */
export const sendApplicationReceivedEmail = async (recruiterEmail, recruiterName, context) => {
 ...
 */
export const sendApplicationStageUpdateEmail = async (candidateEmail, candidateName, context) => {
    const stageMessages = {
 ...
 */
export const sendInterviewScheduledEmail = async (candidateEmail, candidateName, context) => {
 ...
 */
export const sendOfferExtendedEmail = async (candidateEmail, candidateName, context) => {
 ...
 */
export const sendJobExpiringEmail = async (recruiterEmail, recruiterName, jobTitle, companyName, expiresAt) => {

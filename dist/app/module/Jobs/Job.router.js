...
router.post("/:id/apply", authenticate, authorize(["CANDIDATE"]), applicationController.applyToJob);
router.get("/:id/match-score", authenticate, authorize(["CANDIDATE"]), jobController.getMatchScore);
...
router.get("/:id/applications", authenticate, requireRecruiter, applicationController.getApplicantsForJob);
// User routes (require authentication)
router.get("/recruiter/my-jobs", authenticate, requireRecruiter, jobController.getMyJobs);

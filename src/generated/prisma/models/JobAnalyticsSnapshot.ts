...
// @ts-nocheck 
/*
 * This file exports the `JobAnalyticsSnapshot` model and its related types.
 *
...
export type GetJobAnalyticsSnapshotAggregateType<T extends JobAnalyticsSnapshotAggregateArgs> = {
      [P in keyof T & keyof AggregateJobAnalyticsSnapshot]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateJobAnalyticsSnapshot[P]>
    : Prisma.GetScalarType<T[P], AggregateJobAnalyticsSnapshot[P]>
}
...
export type GetJobAnalyticsSnapshotGroupByPayload<T extends JobAnalyticsSnapshotGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<JobAnalyticsSnapshotGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof JobAnalyticsSnapshotGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], JobAnalyticsSnapshotGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], JobAnalyticsSnapshotGroupByOutputType[P]>
      }
    >
  >
...
export type JobAnalyticsSnapshotCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<JobAnalyticsSnapshotFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface JobAnalyticsSnapshotDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['JobAnalyticsSnapshot'], meta: { name: 'JobAnalyticsSnapshot' } }
  /**
   ...
   * })
  **/
  count<T extends JobAnalyticsSnapshotCountArgs>(
    args?: Prisma.Subset<T, JobAnalyticsSnapshotCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], JobAnalyticsSnapshotCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends JobAnalyticsSnapshotGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, JobAnalyticsSnapshotGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetJobAnalyticsSnapshotGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

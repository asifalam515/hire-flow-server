...
// @ts-nocheck 
/*
 * This file exports the `PlatformDailyStats` model and its related types.
 *
...
export type GetPlatformDailyStatsAggregateType<T extends PlatformDailyStatsAggregateArgs> = {
      [P in keyof T & keyof AggregatePlatformDailyStats]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePlatformDailyStats[P]>
    : Prisma.GetScalarType<T[P], AggregatePlatformDailyStats[P]>
}
...
export type GetPlatformDailyStatsGroupByPayload<T extends PlatformDailyStatsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PlatformDailyStatsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PlatformDailyStatsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PlatformDailyStatsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PlatformDailyStatsGroupByOutputType[P]>
      }
    >
  >
...
export type PlatformDailyStatsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PlatformDailyStatsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PlatformDailyStatsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PlatformDailyStats'], meta: { name: 'PlatformDailyStats' } }
  /**
   ...
   * })
  **/
  count<T extends PlatformDailyStatsCountArgs>(
    args?: Prisma.Subset<T, PlatformDailyStatsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PlatformDailyStatsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PlatformDailyStatsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PlatformDailyStatsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPlatformDailyStatsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

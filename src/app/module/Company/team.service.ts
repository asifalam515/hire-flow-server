...
const isCompanyOwner = async (companyId: string, userId: string) => {
...
const isCompanyMember = async (companyId: string, userId: string) => {
  const member = await prisma.companyMember.findFirst({
...
export const getMembers = async (companyId: string, requesterId: string) => {
